...
public final class PrimaryController {
    ...
    @FXML
    private TableColumn<Event, Double> colPrice;
    ...
    public void initialize() {
        ...
        colAvail.setCellValueFactory(c -> new SimpleIntegerProperty(c.getValue().getCategories()
                ...
                .sum()));
        colPrice.setCellValueFactory(c -> new SimpleDoubleProperty(
                c.getValue().getCategories().isEmpty()
                        ? 0
                        : c.getValue().getCategories().get(0).getPrice())
                .asObject());
    ...
    private void refreshTable() {
        ...
        tblEvents.refresh(); // ← force cell re-render
    }
